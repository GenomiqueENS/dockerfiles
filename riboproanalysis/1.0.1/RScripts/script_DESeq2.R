...
###
### Changes to automate analyzes
### Alexandra Bomane <bomane@biologie.ens.fr>
### July 31th, 2015
################################################################################
...
################################################################################
## Setting this variable, we get arguments by the command line
parameters <- commandArgs(T)

workDir <-  parameters[1]
projectName <-  parameters[2]
author <- parameters[3]
targetFile <- parameters[4]
rawDir <- parameters[5]
condRef <- parameters[6]

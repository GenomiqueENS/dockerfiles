...
RUN echo "deb http://cran.r-project.org/bin/linux/ubuntu trusty/" > /etc/apt/sources.list.d/cran.list; \
     ...
     wget http://cran.r-project.org/src/contrib/Archive/MASS/MASS_7.3-45.tar.gz \
          http://cran.r-project.org/src/contrib/Archive/Rcpp/Rcpp_0.12.11.tar.gz \
          http://cran.r-project.org/src/contrib/Archive/Rtsne/Rtsne_0.11.tar.gz; \
     R CMD INSTALL Rcpp_0.12.11.tar.gz MASS_7.3-45.tar.gz Rtsne_0.11.tar.gz;\
     ...
     wget http://cran.rstudio.com/src/contrib/Archive/scatterplot3d/scatterplot3d_0.3-37.tar.gz \
     ...
     R CMD INSTALL scatterplot3d_0.3-37.tar.gz cluster_2.0.4.tar.gz statmod_1.4.24.tar.gz proxy_0.4-16.tar.gz; \
     wget http://cran.rstudio.com/src/contrib/entropy_1.2.1.tar.gz \
          http://cran.rstudio.com/src/contrib/fastICA_1.2-0.tar.gz; \
     if [ ! -f entropy_1.2.1.tar.gz ]; \
     then wget http://cran.rstudio.com/src/contrib/Archive/entropy/entropy_1.2.1.tar.gz; \
     fi; \
     if [ ! -f fastICA_1.2-0.tar.gz ]; \
     then wget     http://cran.rstudio.com/src/contrib/Archive/fastICA/fastICA_1.2-0.tar.gz; \
     fi; \
     R CMD INSTALL entropy_1.2.1.tar.gz fastICA_1.2-0.tar.gz; \
     ...
     if [ ! -f igraph_1.0.1.tar.gz ]; \
     then wget http://cran.r-project.org/src/contrib/Archive/igraph/igraph_1.0.1.tar.gz; \
     fi; \
     ...
     R CMD INSTALL lattice_0.20-33.tar.gz Matrix_1.2-6.tar.gz irlba_2.1.2.tar.gz igraph_1.0.1.tar.gz; \
     ...
     R CMD INSTALL spam_1.3-0.tar.gz maps_3.1.1.tar.gz fields_8.4-1.tar.gz; \
